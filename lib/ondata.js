...
module.exports = function ondata(data) {
  ...
  if (data.text) {
    ...
    if (data.retweeted_status) {
      ...
      this.emit('tweet:retweet:' + data.retweeted_status.id_str,
        data, for_user);
    ...
    if (data.in_reply_to_status_id_str) {
      ...
      this.emit('tweet:reply:' + data.in_reply_to_status_id_str,
        data, for_user);
    ...
    if (data.in_reply_to_screen_name) {
      ...
      this.emit('tweet:mention:' + data.in_reply_to_screen_name,
        data, for_user);
